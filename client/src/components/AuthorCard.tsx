...
const AuthorCard: React.FC<AuthorCardProps> = ({
  ...
  return (
    <figure className="relative flex flex-col-reverse rounded-lg dark:bg-slate-800 dark:highlight-white/5">
      <figcaption className="flex items-center space-x-4">
        ...
        <div className="flex-auto">
          ...
          <div className="text-sm mt-0.5 dark:text-slate-300 capitalize">
